...
Please note you will need a Nvidia Cuda GPU with at least 4gb of memory to be able to run Yolov3 at the default 608 resolution. If you use a GPU with less memory you will need to decrease the resolution (and accept lower recognition accuracy).
<BR>
<BR>
